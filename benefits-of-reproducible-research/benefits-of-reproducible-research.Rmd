...
colnames(results) <- c("Source","Injury Type","Studies","Number","Fixed-effects OR","FE OR 95% LL","FE OR 95% UL","Random-effects OR","RE OR 95% LL","RE OR 95% UL","(FE 95% CI)","(RE 95% CI)")
```
