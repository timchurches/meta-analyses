...
results$FE.CI <- with(results,paste("(",formatC(FE.LL95,digits=2),"-",formatC(FE.UL95,digits=2),")"))
results$RE.CI <- with(results,paste("(",formatC(RE.LL95,digits=2),"-",formatC(RE.UL95,digits=2),")"))
colnames(results) <- c("Source","Injury Type","Studies","n","Fixed-effects OR","FE OR 95% LL","FE OR 95% UL","Random-effects OR","RE OR 95% LL","RE OR 95% UL","FE OR 9% CI","RE OR 95% CI")
```
```{r table, results='asis'} 
print(xtable(results[,c(1,2,3,4,5,11,8,12)],digits=2),type="html",include.rownames=T)
``` 
