...
# This was the original code which worked with earlier versions of the metafor package
...
# This now works with v1.9.x of metafor.
studies <- escalc(measure='OR',ai=cases.helmet,bi=cases.no.helmet,ci=controls.helmet,di=controls.no.helmet,data=studies)
